...
1. **📡 Синхронизация серверов** (обязательно!)
   ...
   - Зайди в бот → **Админ панель** → **Серверы** → **Синхронизация**
   - Нажми **Синхронизация** и дождись завершения
   - Без этого пользователи не смогут выбирать страны!
   - **Если добавил новый сервер на панели Remnawave** — зайди снова в **Серверы** → **Синхронизация**, чтобы он появился в боте; затем в **Список серверов** включи для него «доступен» и при необходимости настрой цену/страну.
